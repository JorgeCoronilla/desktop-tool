...
- Expandable/collapsible folder navigation with intelligent caching.
...
- **Auto-refresh**: Automatic tree updates after file operations.
- **Smart Cache**: Intelligent folder content caching for improved performance.
...
- **14 Specialized Tools**: Complete file and document operation capabilities.
...
- **Integrated MCP Service**: Direct tool execution without network overhead.
...
- **read_text_file**: Read content from text files
- **write_text_file**: Write content to text files
- **create_directory**: Create new directories
- **delete_file_or_directory**: Delete files or directories
- **list_directory**: List directory contents
- **copy_file_or_directory**: Copy files or directories
- **move_file_or_directory**: Move/rename files or directories
- **list_files_by_criteria**: Advanced file filtering
- **delete_multiple_items**: Batch deletion operations

### Document Processing

- **read_pdf**: Extract text from PDF files
- **ocr_pdf**: OCR text extraction from scanned PDFs
- **read_excel**: Read Excel/CSV files and sheets
- **write_excel**: Create new Excel files
- **modify_excel**: Update existing Excel files
...
- **MCP Security**: Automatic parameter validation and secure tool execution.
...
- "Copy all .txt files from this folder to the backup directory."
...
- Watch automatic file tree updates after copy/move operations.
...
- MCP tools require proper OpenAI API configuration.

## Recent Improvements

- **MCP Integration**: Migrated from custom tool system to industry-standard Model Context Protocol.
- **Auto-refresh File Tree**: Automatic updates after file operations without manual refresh.
- **Intelligent Caching**: Smart folder content caching for improved performance.
- **14 Specialized Tools**: Complete set of file and document processing capabilities.
- **Direct Tool Execution**: Eliminated network overhead with integrated MCP service.
...
- **MCP Server Standalone**: Independent MCP server for Claude Desktop integration.
- **Advanced File Filtering**: Enhanced search and filtering capabilities.
- **Bulk Operations UI**: Visual interface for batch file operations.
