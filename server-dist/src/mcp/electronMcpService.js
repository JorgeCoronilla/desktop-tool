...
exports.electronMCPService = exports.ElectronMCPService = void 0;
const electronMcpServer_1 = require("./electronMcpServer");
/**
...
class ElectronMCPService {
    constructor() {
        this.mcpServer = new electronMcpServer_1.ElectronMCPServer();
    }
    /**
    ...
    generateToolDocumentation() {
        ...
        documentation += '\n## Formato de Uso\n';
        documentation +=
            'Para usar una herramienta, responde con el siguiente formato JSON:\n';
        documentation += '```json\n';
        documentation += '{\n';
        ...
        documentation += '```\n\n';
        documentation +=
            '**IMPORTANTE:** Solo responde con JSON cuando necesites usar una herramienta. Para respuestas normales, usa texto regular.\n';
...
exports.ElectronMCPService = ElectronMCPService;
// Instancia singleton para uso global
exports.electronMCPService = new ElectronMCPService();
